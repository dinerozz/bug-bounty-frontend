...
export const Card: FC<{
  ...
  return loading ? (
    ...
    <div
      className={`${className} border-solid border-[1px] border-granite-gray w-full bg-[rgba(60,34,37,0.3)] backdrop-blur-md p-5 rounded-lg shadow-sm shadow-orange-700 relative`}
    >
